...
const { writeOutputBuffer, cleanupOldOutputs } = require('@propdfmate/storage');
...
setInterval(() => {
  cleanupOldOutputs(Number(process.env.OUTPUT_RETENTION_MS || 1800000)).catch(() => {});
}, Number(process.env.CLEANUP_INTERVAL_MS || 300000));
