(() => {
  ...
  const initUpload = (wrapper) => {
    const input = wrapper.querySelector('input[type=file]');
    const zone = wrapper.querySelector('.upload-zone');
    const preview = wrapper.querySelector('.preview');
    const progress = wrapper.querySelector('.progress');
    const processing = wrapper.querySelector('.processing');
    const downloadArea = wrapper.querySelector('.download-area');
  ...
  document.querySelectorAll('[data-upload-component]').forEach(initUpload);
